...
class SidebarTest extends TestCase
{
    ...
    #[Test]
    public function it_renders_notes_as_escaped_running_text(): void
    {
        $html = Sidebar::make()
            ->section('Status', fn (Section $section) => $section->note('Past due <b>since</b> Tuesday.'))
            ->toHtml();

        $this->assertStringContainsString('<p class="hs-sidebar-note">', $html);
