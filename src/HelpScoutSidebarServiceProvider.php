...
class HelpScoutSidebarServiceProvider extends ServiceProvider
{
    ...
    protected function registerResolution(): void
    {
        ...
        $this->app->bind(
            ...
            fn (Application $app): CustomerResolver => $app->make($app['config']->get('helpscout-sidebar.resolver')),
        );

        $this->app->bind(
            BuildsSidebar::class,
            fn (Application $app): BuildsSidebar => $app->make($app['config']->get('helpscout-sidebar.builder')),
        );
    }
    ...
    public function provides(): array
    {
        return [
            ...
            BuildsSidebar::class,
            CustomerResolver::class,
            MailboxApiClient::class,
            MailboxApiConfig::class,
