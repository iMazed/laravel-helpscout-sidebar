 ...
 *
 * Deliberately absent: any way to read the customer's email address. Customer
 * identity is established server-side through the Mailbox API — a value that
 * reaches the server from the browser is outside the request signature. See
 * docs/security.md.
 */
(function () {
    'use strict';
